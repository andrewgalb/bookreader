...
namespace Library.Data
{
    class BookRepository
    {
        ...
        static public Book Details(string ISBN)
        {
            List<Book> books = ReadBooks();
        ...
        /// <param name="ISBN"></param>
        static public void Create(string Title, string Author, string Genre, string ISBN)
        {
            List<Book> books = ReadBooks();
            books.Add(new Book(Title, Author, Genre, ISBN));
            SaveBooks(books);
        ...
        /// <param name="Genre"></param>
        /// <param name="ISBN"></param>
        static public void Update(string Title, string Author, string Genre, string ISBN)
        {
            List<Book> books = ReadBooks();
            Book b = FindBookInList(ISBN, books);
